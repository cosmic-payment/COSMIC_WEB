...
export const CreditCard = ({
    ...
    const originalWidth = vertical ? 190 : 316;
    const originalHeight = vertical ? 316 : 190;
            ...
            >
                ...
                {shine && (
                    <div className="pointer-events-none absolute inset-0 z-20 overflow-hidden rounded-[inherit]">
                        <div className="card-shine absolute inset-y-0 w-1/3 bg-gradient-to-r from-transparent via-white/40 to-transparent" />
                    </div>
                )}
                ...
                {vertical ? (
                    <div className="relative flex h-full flex-col justify-between">
                        ...
                        <div className="flex flex-col gap-2.5 px-1">
                            <div className="h-6 w-9 rounded-md bg-gradient-to-br from-amber-200 to-yellow-400" />
                            <p className={cx("text-sm leading-[normal] font-semibold tracking-[1.5px] tabular-nums", styles[type].footerText)}>
                                {cardNumber}
                            </p>
                        </div>
                        ...
                        <div className="flex items-end justify-between px-1">
                            <div>
                                <p className={cx("text-[8px] leading-normal font-semibold tracking-[0.6px] uppercase opacity-70", styles[type].footerText)}>
                                    Card holder
                                </p>
                                <p
                                    style={{
                                    ...
                                    className={cx("mt-0.5 text-xs leading-snug font-semibold tracking-[0.6px] uppercase", styles[type].footerText)}
                                >
                                    {cardHolder}
                                </p>
                            </div>
                            <div className="text-right">
                                ...
                                <p className={cx("mt-0.5 text-xs leading-[normal] font-semibold tracking-[0.6px] tabular-nums", styles[type].footerText)}>
                                    {cardExpiration}
                                </p>
                            </div>
                        </div>
